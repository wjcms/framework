...
class App extends Container
{
    ...
    public static function start()
    {
        ...
        $app->bindProviders();
        spl_autoload_register([$app,'atuoloadFacade']);
        $app->boot();
    }
    ...
    *自动加载外观类
    */
    public function atuoloadFacade($class)
    {
        $facades = app('Config')->get('app.facades');
        if (isset($facades[$class])) {
            class_alias($facades[$class], $class);
        }
